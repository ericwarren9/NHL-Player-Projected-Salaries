...
salaryCF15 <- read_csv("RawData/CapFriendly 2015-16 Data.csv")
...
salaryCF15$position <- sapply(salaryCF15$position, firstposition)
salaryCF15$position <- sapply(salaryCF15$position, realposition)
