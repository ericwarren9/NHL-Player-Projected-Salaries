...
capFriendlyData10 <- capFriendlyData %>%
  ...
  mutate(ref_date = mdy(12312010),
         age = year(ref_date)- year(birthdate),
         total_cap = 59400000,
