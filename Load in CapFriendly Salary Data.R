...
capFriendlyData10 <- capFriendlyData %>%
  ...
  mutate(ref_date = mdy(07012010),
         age = ifelse(as.numeric(substr(birthdate, 6, 7)) < 7 | birthdate == '1993-07-01' | birthdate == '1994-07-01' | birthdate == '1995-07-01', year(ref_date) - year(birthdate), 0),
         age = ifelse(as.numeric(substr(birthdate, 6, 7)) >= 7 & birthdate != '1993-07-01' & birthdate != '1994-07-01' & birthdate != '1995-07-01', year(ref_date) - year(birthdate) - 1, age),
         total_cap = 59400000,
