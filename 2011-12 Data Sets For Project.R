...
salaryCF11 <- read_csv("RawData/CapFriendly 2011-12 Data.csv")
...
salaryCF11$position <- sapply(salaryCF11$position, firstposition)
salaryCF11$position <- sapply(salaryCF11$position, realposition)
